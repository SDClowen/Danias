...
public class Log
{
    ...
    {
        Event.Manager.FireEvent("OnAddLog", string.Format(format, args), logLevel);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", message, logLevel);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", obj.ToString(), LogLevel.Notify);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", LanguageManager.GetLang(key, args), LogLevel.Notify);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", obj.ToString(), LogLevel.Debug);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", obj.ToString(), LogLevel.Warning);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", LanguageManager.GetLang(key, args), LogLevel.Warning);
    }
    ...
    {
        Event.Manager.FireEvent("OnAddLog", obj.ToString(), LogLevel.Error);
    }
    ...
    {
        Event.Manager.FireEvent("OnChangeStatusText", obj.ToString());
    }
    ...
    {
        Event.Manager.FireEvent("OnChangeStatusText", LanguageManager.GetLang(key, args));
    }
